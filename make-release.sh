...
info "Synchronizing 'at91bootstrap.bin'..."
rm -f "${output_dir}"/at91bootstrap*
rsync -a --chmod=a-x "${build_dir}/board/icdtcp3/at91bootstrap.bin" "${output_dir}/at91bootstrap-${version}.bin"
test $? -eq 0 || error "Synchronizing 'at91bootstrap.bin' failed"
